...
class GetFirstLoadUserAdviceUseCase(private val preferencesRepositoryFactory: PreferencesRepositoryFactory) :
    SynchronousUseCase<Boolean>() {

    override fun execute(): Boolean =
        preferencesRepositoryFactory.create(Strategy.PREFERENCES).getFirstLoadUserAdvice()
}
