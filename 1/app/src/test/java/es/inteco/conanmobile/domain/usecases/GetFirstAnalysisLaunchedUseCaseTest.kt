...
class GetFirstAnalysisLaunchedUseCaseTest {
    ...
    fun getFirstAnalysisLaunched_should_set_first_analysis_launched_access_in_preferences() {
        ...
        Mockito.`when`(preferencesRepository.getFirstAnalysisLaunched())
            .thenReturn(
                Mockito.anyBoolean()
            )
        ...
        verify(preferencesRepository).getFirstAnalysisLaunched()
    }

    private fun createUseCase(): GetFirstAnalysisLaunchedUseCase =
